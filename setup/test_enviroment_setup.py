...
QUALIFIER_DIR_PATH = os.getenv('QUALIFIER_DIR_PATH')
...
os.chdir(QUALIFIER_DIR_PATH+QUALIFIER_ENV_CONFIG_PATH)

# enviroment container config
dockerContainerConfigParser = ConfigFileParser(ENV_CONTAINER_CONFIG)
